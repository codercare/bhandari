...
class rtvaxi_Testimonials2 extends Widget_Base {

	public static $slug = 'rtvaxi-testimonials2';

	public function get_name() { return self::$slug; }

	public function get_title() { return (esc_html__('Testimonials 2', 'vaxi')); }
...
// boxes services slick slider
  ...
  $('.testimonialsb').slick({
    ...
    echo do_shortcode( '[rtvaxi_test2 ' . $this->get_render_attribute_string( 'shortcode' ) . ']' );
	}
