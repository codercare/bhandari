...
class Dustro_Icons4 extends Widget_Base {

	public static $slug = 'dustro-icons4';

	public function get_name() { return self::$slug; }

	public function get_title() { return __('Icon boxes style 4 (circle on top icon)', self::$slug); }
  ...
  if ( $settings['dustro_buttontext'] ) {
   ...
   if ( $settings['dustro_buttonurl']['is_external'] ) {
    ...
    echo do_shortcode( '[rtvaxi_icons4 ' . $this->get_render_attribute_string( 'shortcode' ) . ']' );
	}
