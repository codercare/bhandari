...
class Dustro_Icons3 extends Widget_Base {

	public static $slug = 'dustro-icons3';

	public function get_name() { return self::$slug; }

	public function get_title() { return __('Icon box style 3 (boxed icons in row)', self::$slug); }
   ...
   if ( $settings['dustro_removebutton'] ) {
    ...
    echo do_shortcode( '[rtvaxi_icons3 ' . $this->get_render_attribute_string( 'shortcode' ) . ']' );
	}
