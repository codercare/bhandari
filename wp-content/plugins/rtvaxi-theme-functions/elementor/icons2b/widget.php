...
class Dustro_Icons2b extends Widget_Base {

	public static $slug = 'dustro-icons2b';

	public function get_name() { return self::$slug; }

	public function get_title() { return __('Icon style 2 (left)', self::$slug); }
   ...
   $settings = $this->get_settings_for_display();  
    ...
    echo do_shortcode( '[rtvaxi_icons2b ' . $this->get_render_attribute_string( 'shortcode' ) . ']' );
	}
