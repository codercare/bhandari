...
class Dustro_Custombutton2 extends Widget_Base {

	public static $slug = 'dustro-custombutton2';

	public function get_name() { return self::$slug; }

	public function get_title() { return __('Custom button 2', self::$slug); }
   ...
   if ( $settings['dustro_buttonurl']['is_external'] ) {
    ...
    echo do_shortcode( '[rtvaxi_custombutton2 ' . $this->get_render_attribute_string( 'shortcode' ) . ']' );
	}
}