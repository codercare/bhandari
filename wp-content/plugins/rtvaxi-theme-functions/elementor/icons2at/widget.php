...
class Dustro_Icons2at extends Widget_Base {

	public static $slug = 'dustro-icons2at';

	public function get_name() { return self::$slug; }

	public function get_title() { return __('Icon style 2 (right) with title only', self::$slug); }
   ...
   $settings = $this->get_settings_for_display();  
    ...
    echo do_shortcode( '[rtvaxi_icons2at ' . $this->get_render_attribute_string( 'shortcode' ) . ']' );
	}
